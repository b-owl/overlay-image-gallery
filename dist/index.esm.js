...
var SingleImageModal = function (props) {
    ...
    var _a = useState(0), startX = _a[0], setStartX = _a[1];
    var _b = useState(null), direction = _b[0], setDirection = _b[1];
    var _c = useState(currentIndex), activeIndex = _c[0], setActiveIndex = _c[1];
    var imageRefs = useRef([]);
...
var AlbumModal = function (props) {
    ...
    var _a = useState(false), showSingleImage = _a[0], setShowSingleImage = _a[1];
    var _b = useState(selectedImageIndex), currentImageIndex = _b[0], setCurrentImageIndex = _b[1];
...
var ImageGallery = function (props) {
    ...
    var _b = useState(0), selectedImageIndex = _b[0], setSelectedImageIndex = _b[1];
